...
access_key = "PVveA6iZwnixQNIYyLyHgrLvb8zXM8CYMo1BhsCsmaxpPmb3bG2twgatU%2BEtVgyHJWxIzv66VF8zFdG8dAtI5Q%3D%3D"
...
def getTourPointData(item, yyyymm, jsonResult):
    ...
    jsonResult.append({'yyyymm': yyyymm, 'addrCd': addrCd, 'gungu': gungu, 'sido': sido, 'resNm': resNm, 'rnum': rnum,
                       'ForNum': ForNum, 'NatNum': NatNum})
...
def main():
    ...
    print('%s_광광지입장정보_%d_%d.json SAVED'%(sido, nStartYear, nEndYear-1))
