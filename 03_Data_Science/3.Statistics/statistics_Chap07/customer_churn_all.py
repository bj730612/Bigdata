# 목적 : (print(y_predicted_rounded)밑으로 생략)
import numpy as np
import pandas as pd
...
# Split total charges into quartiles, create binary indicator variables for each of the quartiles,
...
print("Probalbility of churn when account length charges by 1: %.2f"
