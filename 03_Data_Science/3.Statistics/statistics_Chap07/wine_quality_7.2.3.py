...
wine_smaple = pd.concat([reds_sample, whites_sample], ignore_index=True)

print("\nprint: wine['in_smaple']")
print(wine['in_sample'])
print(pd.crosstab(wine.in_sample, wine.type, margins=True))

sns.set_style("dark")
g = sns.pairplot(wine_smaple, kind='reg', plot_kws={"ci": False, "x_jitter": 0.25, "y_jitter": 0.25}, hue='type',
...
plt.suptitle('Histograms and Scatter Plots of Quality, Alcohol, and Residual Sugar', fontsize=14,
             horizontalalignment='center', verticlalignment='top', x=0.5, y=0.999)
plt.show()
